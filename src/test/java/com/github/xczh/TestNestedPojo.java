...
public class TestNestedPojo {
  ...
  public String s11;
  public String s12;
  public TestPojo nestedPojo;

  public static TestNestedPojo getInstance() {
    TestNestedPojo pojo = new TestNestedPojo();
    pojo.i1 = 1;
    pojo.i2 = 12345678;
    pojo.l3 = 123456789L;
    ...
    pojo.nestedPojo = TestPojo.getInstance();
    return pojo;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestNestedPojo testPoJo = (TestNestedPojo) o;
    return i1 == testPoJo.i1
        ...
        && Objects.equals(nestedPojo, testPoJo.nestedPojo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(i1, i2, l3, l4, b5, b6, f7, f8, d9, d10, s11, s12, nestedPojo);
  }
}
